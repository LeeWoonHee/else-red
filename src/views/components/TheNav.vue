<template>
  <header ref="header">
    <nav>
      <div class="w-full blex-right mr-0 lg:mr-4">
        <div
            @click="openMenu"
      ...
      >
        ...
        >
          ...
          <ul
              ...
              class="w-full lg:w-1/2 blex-right lg:order-2 order-1">
            ...
            <router-link
                ...
                tag="li"
                class="list"
                @click.native="$router.push('/').then(() => {$router.go()}).catch(()=>{$window.location.reload()})"
            >
            ...
            <router-link
                ...
                tag="li"
                class="list"
                @click.native="$router.push('/teams').then(()=>{$router.go()}).catch(()=>{$window.location.reload()})"
            >
              <kinesis-container>
                <kinesis-element
                    :strength="$store.state.windowWidth > 1024 ? 20 : 0"
            ...
            <router-link
                ...
                tag="li"
                class="list"
                @click.native="$router.push('/contacts').then(()=>{$router.go()}).catch(()=>{$window.location.reload()})"
            >
              <kinesis-container>
                <kinesis-element
                    :strength="$store.state.windowWidth > 1024 ? 20 : 0"
